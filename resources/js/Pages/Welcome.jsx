...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    ...
    return (
        <>
                                <Navbar auth={auth} /> {/* Using Navbar here */}
                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <main className="mt-6">
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                        ...
                                        >
                                            ...
                                            <div className="pt-3 sm:pt-5 lg:pt-0">
                                                ...
                                                <p className="mt-4 text-sm/relaxed">
                                                    Merupakan Website peminjaman kendaraan yang dimana dapat meminjam kendaraan dari berbagai kantor cabang yang dimiliki oleh PT. Sekawan
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <a
                                    href="https://www.sekawanmedia.co.id/layanan/"
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Kami membantu mengembangkan perusahaan, mulai dari perusahaan menengah hingga enterprise, dengan cara mentransformasikan proses bisnis mereka menjadi digital dan dilengkapi dengan otomatisasi.
                                        </p>
                                    </div>
                                ...
                                <a
                                    href="https://www.sekawanmedia.co.id/solusi/"
                                    className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                                >
                                    <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                        <svg
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Kami menawarkan solusi yang luas dan beragam dari studi kasus yang telah diuji secara menyeluruh selama bertahun-tahun.
                                        </p>
                                    </div>
                                ...
                                <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800">
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Kami terus mengembangkan sudut pandang dan cara kerja dalam melihat tantangan teknologi dan industri sehingga kami dapat terus memberikan hasil yang terukur, aplikatif, dan terbaik untuk klien.
                                        </p>
                                    </div>
                                </div>
                            </div>
